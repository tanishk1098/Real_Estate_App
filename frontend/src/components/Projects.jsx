...
useEffect(()=>{
    ...
    .then(data => {
        console.log(`Fetched property data: ${JSON.stringify(data)}`);
        console.log(`Fetched property data: ${JSON.stringify(projectsData)}`);
...
const prevProject = ()=>{
  ...
  return (
    ...
    <div className='overflow-hidden'>
        ...
        >
            {propertyData.map((project, index)=>(
               <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
                <img src={project.images} alt={project.title} className='w-full h-auto mb-14'/>
